...
def page_title():
    ...
    st.markdown(f'<h1 style="color:red;font-size:24px;">{"Source code and a quick guide can be found on https://github.com/dhiego22/gentle"}</h1>', unsafe_allow_html=True)
